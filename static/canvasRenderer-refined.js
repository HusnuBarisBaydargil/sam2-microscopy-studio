(() => {
    ...
    function drawAnnotationOverlay(ctx, annotation, isHighlighted, cameraZoom, classColor, showLabels = true) {
        ...
        if (showLabels) drawAnnotationLabel(ctx, annotation, x, y, classColor, cameraZoom);
        ctx.restore();
